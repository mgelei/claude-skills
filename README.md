...
- **[prompt-audit](plugins/prompt-audit/skills/prompt-audit/SKILL.md)** — Audits an existing prompt against Claude Opus 5.5 practices, reports the highest-impact findings for confirmation, then renders the rewritten prompt in a code block.
